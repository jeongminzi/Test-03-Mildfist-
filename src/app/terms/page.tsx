  ...
  return (
    <div className="flex-1 bg-bg-default">
      <div className="max-w-2xl mx-auto px-5 sm:px-8 py-10 sm:py-12">
        ...
        <h1 className="text-xl font-semibold tracking-tight mb-6 text-text-neutral">이용약관</h1>

        <div className="flex flex-col gap-8 text-sm text-text-neutral-muted leading-relaxed">
          <section>
