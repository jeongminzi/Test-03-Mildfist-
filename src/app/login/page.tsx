    ...
    <div className="flex-1 flex items-center justify-center px-4 py-12 bg-bg-default">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="flex items-center justify-center mb-3 w-12 h-12 rounded-full bg-bg-brand-solid">
          ...
          <h1 className="text-xl font-semibold text-text-neutral">MildFist</h1>
        ...
        {/* Mode toggle */}
        <div className="flex mb-6 p-1 bg-bg-neutral-weak rounded-control">
            ...
            return (
              <button
                ...
                className={`flex-1 text-sm font-medium py-2 rounded-lg transition-colors cursor-pointer border-none ${
                  active ? "bg-bg-floating text-text-neutral" : "bg-transparent text-text-neutral-subtle"
                }`}
              >
                {m === "login" ? "로그인" : "회원가입"}
              </button>
        ...
        {/* Demo accounts */}
        <Card surface="weak" padding="md" className="mt-6">
          <p className="text-xs font-medium mb-2 text-text-neutral">데모 계정</p>
          <div className="flex flex-col gap-1.5 text-xs text-text-neutral-muted">
        ...
        <p className="mt-4 text-center text-xs text-text-neutral-subtle">
          가입 시{" "}
